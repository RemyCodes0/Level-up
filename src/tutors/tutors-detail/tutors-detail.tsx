        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {(tutor.teachingApproach ||
              tutor.teachingStyle ||
              tutor.studentBenefits?.length > 0 ||
              tutor.location) && (
                ...
                <CardContent className="space-y-6 pt-6">
                  ...
                  {tutor.location && (
                    <>
                      {(tutor.teachingApproach ||
                        tutor.teachingStyle ||
                        tutor.studentBenefits?.length > 0) && <Separator />}
            ...
            {tutor.availability && tutor.availability.length > 0 && (
              <Card className="border-0 shadow-lg bg-white/80 backdrop-blur">
                <CardHeader className="bg-gradient-to-r from-slate-50 to-blue-50">
                  ...
                  <CardDescription>
                    Times when {tutor.user.name.split(" ")[0]} is available for
                    sessions
                  </CardDescription>
                </CardHeader>
                <CardContent className="pt-6">
                  <div className="space-y-3">
                    {tutor.availability.map((day: any, index: number) => (
                      ...
                      >
                        <div className="w-28 font-semibold text-slate-900">
                          {day.day}
                        </div>
                  ...
                  <div className="mt-4 p-3 rounded-lg bg-blue-50 border border-blue-200">
                    <p className="text-sm text-blue-700">
                      <span className="font-semibold">Note:</span> Availability
                      may vary during exam periods. Please message to confirm
                      specific times.
                    </p>
                  </div>
                </CardContent>
            ...
            <div className="sticky top-20 space-y-4">
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur overflow-hidden">
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    Get started with {tutor.user.name.split(" ")[0]}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
