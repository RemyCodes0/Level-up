  ...
  useEffect(() => {
    const fetchTutor = async () => {
      try {
        ...
        setSelectedSlot(res.data.tutor.availability)
      } catch (error) {
        console.error(error)
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <span>{selectedSlot ? selectedSlot.day : "No slot selected"}</span>
                      </div>
                      <div className="flex items-center gap-2 text-muted-foreground">
                        <Clock className="h-4 w-4" />
                        <span>
                          {selectedSlot ? `${selectedSlot.from} – ${selectedSlot.to}` : "No time selected"} ({duration} minutes)
                        </span>
                      </div>
                      <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <div className="border-t pt-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm">${tutor.hourlyRate.toFixed(2)}/hour</span>
                      </div>
                      <div className="flex items-center justify-between mb-2">
