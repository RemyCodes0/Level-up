...
export default function BookingsPage() {
  ...
  const upcomingSessions = mockSessions.filter((s) => s.status === "confirmed" || s.status === "pending")
  const pastSessions = mockSessions.filter((s) => s.status === "completed")

  const handleReviewSubmit = (rating: number, comment: string) => {
    console.log("[v0] Review submitted:", { rating, comment, sessionId: selectedSession?.id })
  ...
  const SessionCard = ({ session }: { session: MockSession }) => {
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {session.notes && <p className="text-sm text-muted-foreground mb-4 italic">Note: {session.notes}</p>}
      ...
      <div className="container mx-auto px-4 py-8">
            ...
            {upcomingSessions.length > 0 ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>You don't have any scheduled tutoring sessions yet.</CardDescription>
                </CardHeader>
                <CardContent>
                  <a href="/tutors">
            ...
            {pastSessions.length > 0 ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Your completed sessions will appear here.</CardDescription>
                </CardHeader>
              </Card>
            )}
          </TabsContent>
        ...
        {selectedSession && (
          <ReviewDialog
            ...
            tutorName={MOCK_TUTORS.find((t) => t.id === selectedSession.tutorId)?.fullName || ""}
